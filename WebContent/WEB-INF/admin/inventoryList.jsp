...
.thumb_box { width:150px; margin:24px auto; margin-bottom:10px; height:auto; overflow:hidden;
				...
				<div class="thumbnail">
					...
					<div class="caption">
						<a href="${path1 }/ProductDetail.do?gcode=${pro.gcode}">
							<h3 class="pro_title"><strong>${pro.gname }</strong></h3>
						...
						<div class="btn-group">
							...
							<c:if test="${sid.equals('admin') }">
								...
								<a href="${path1 }/UpdateProduct.do?gcode=${pro.gcode }" class="btn btn-success" role="button">상품 수정</a>
								<a href="${path1 }/DeleteProduct.do?gcode=${pro.gcode }" class="btn btn-warning" role="button">상품 삭제</a>
							</c:if>
						</div>
					</div>
				</div>
