		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<fmt:parseDate value="${user.rdate }" var="rdate" pattern="yyyy-MM-dd HH:mm:ss" />
						<span title="전화번호 : ${user.tel }, 이메일 : ${user.email }"><fmt:formatDate value="${rdate }" pattern="yyyy년 MM월 dd일" /></span>
					</td>
					<td>
