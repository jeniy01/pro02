				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input type="radio" name="rpoint" id="rpoint5" value="5" checked><label for="rpoint5">매우 만족</label> &nbsp; &nbsp;
							<input type="radio" name="rpoint" id="rpoint4" value="4"><label for="rpoint4">만족</label> &nbsp; &nbsp;
							<input type="radio" name="rpoint" id="rpoint3" value="3"><label for="rpoint3">보통</label> &nbsp; &nbsp;
							<input type="radio" name="rpoint" id="rpoint2" value="2"><label for="rpoint2">불만족</label> &nbsp; &nbsp;
							<input type="radio" name="rpoint" id="rpoint1" value="1"><label for="rpoint1">매우 불만족</label> &nbsp; &nbsp;
						</td>
					</tr>
					<tr>
