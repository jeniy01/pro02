				...
				<tbody>
					<tr>
						...
						<td>
							...
							<input type="hidden" id="gcodeck" name="gcodeck" value="no">
							<input type="button" value="상품코드 발급" class="btn btn-primary" onclick="productCodeGenerator()">
						</td>
					</tr>
					<tr>
						<th><label for="gname">상품명</label></th>
						<td>
							<input type="text" name="gname" id="gname" title="40자 내로 작성" placeholder="40자 내로 작성" class="form-control" required>
						</td>
					</tr>
					<tr>
						<th><label for="gram">중량</label></th>
						<td>
							<input type="text" name="gram" id="gram" title="100자 내로 작성" placeholder="100자 내로 작성" class="form-control">
						</td>
					</tr>
					<tr>
						<th><label for="mung">상품 설명</label></th>
						<td>
							<textarea rows="5" cols="100" name="mung" id="mung" maxlength="500" title="500자 내로 작성" class="form-control">500자 이내</textarea>
						</td>
					</tr>
					<tr>
					...
					<!-- <tr>
						...
						<td>
							<input type="url" name="utburl" id="utburl" class="form-control">
						</td>
					</tr>
					<tr>
						<th><label for="bookidx">특이사항</label></th>
						<td>
							<textarea rows="5" cols="100" name="bookidx" id="bookidx" maxlength="500" title="500자 내로 작성" class="form-control"></textarea>
						</td>
					</tr> -->
					<tr>
						<td colspan="2">
		...
		function productCodeGenerator(){
			...
			$.ajax({
				...
				success:function(result){
					console.log(result);
					var msg = result.msg;
					var proCode = result.gcode;
					$("#gcodeck").val("yes");
					$("#gcode").val(proCode);
					$("#gcodetxt").html("("+proCode+")");
