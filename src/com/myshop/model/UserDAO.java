...
public class UserDAO {
	...
	public void userPointCount(String id){
		try {
			con = Oracle11.getConnection();
			pstmt = con.prepareStatement(Oracle11.USER_POINT_COUNT);
			pstmt.setString(1, id);
			pstmt.executeUpdate();
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
	...
	/*public ArrayList<User> UserList2() throws InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidAlgorithmParameterException, BadPaddingException, IllegalBlockSizeException{
		ArrayList<User> uList2 = new ArrayList<User>();
		try {
			con = Oracle11.getConnection();
			pstmt = con.prepareStatement(Oracle11.USER_SELECT_ALL);
			rs = pstmt.executeQuery();
